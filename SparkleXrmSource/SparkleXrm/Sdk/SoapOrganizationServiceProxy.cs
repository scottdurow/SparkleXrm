//// SoapOrganizationServiceProxy.cs
////
...
//    public class SoapOrganizationServiceProxy : IOrganizationService
//    {
//        #region Fields
...
//            {
//                OrganizationServiceProxy.UserSettings = (UserSettings)Retrieve(UserSettings.EntityLogicalName, Page.Context.GetUserId(), new string[] { "AllColumns" });
...
//            EntityCollection result = RetrieveMultiple(fetchXml);
...
//        private string GetAssociateRequest(string entityName, Guid entityId, Relationship relationship, List<EntityReference> relatedEntities)
//        {
...
//        }
//        private string GetDisassociateRequest(string entityName, Guid entityId, Relationship relationship, List<EntityReference> relatedEntities)
//        {
...
//        private string GetRetrieveMultipleRequest(string fetchXml)
//        {
...
//        private EntityCollection GetEntityCollectionResults(XmlDocument resultXml, Type entityType)
//        {
...
//        private string GetRetrieveRequest(string entityName, string entityId, string[] attributesList)
//        {
...
//        }
//        private string GetCreateRequest(Entity entity)
//        {
...
//        private string GetSetStateRequest(Guid id, string entityName, int stateCode, int statusCode)
//        {
...
//        }
//        public string Delete_(string entityName, Guid id)
//        {
...
//        private string GetDeleteRequest(string entityName, Guid id)
//        {
...
//        public void BeginDelete(string entityName, Guid id, Action<object> callBack)
//        {
...
//        private string GetExecuteRequest(OrganizationRequest request)
//        {
...
//        private XmlDocument GetResponse(string soapXmlPacket, string action, Action<object> asyncCallback)
//        {
...
//        private Exception GetSoapFault(XmlDocument response)
//        {
